/**
 * 单调栈中存放的是数组中的索引
 * 1、在一个数组中，确定左右两侧比它小的数有哪些，如果没有返回 -1
 **/
...
//     while (!stack.isEmpty()) {
//         const popIndex = stack.pop()
//         const node = new indexNode(popIndex, stack.isEmpty() ? -1 : stack.pop(), -1)
//         res.push(node)
//     }
//     return res
// }
...
//             const popIndex = stack.pop()
//             const leftLessIndex = stack.isEmpty() ? -1 : stack.peek()
//             const node = new Node(popIndex, leftLessIndex, i)
//             res.push(node)
//         }
//         stack.push(i)
//     }
...
//     while (!stack.isEmpty()) {
//         const popIndex = stack.pop()
//         const node = new Node(popIndex, stack.isEmpty() ? -1 : stack.peek(), -1)
//         res.push(node)
//     }
//     return res
// }
